<h1>Site Mario e Luidi</h1>
<br>

<h2>Esse é um projeto de um site de serviços de encanamento.</h2>
<p>Por este site ser destinado a serviço de encanadores, é justo incluir nosso querido Mario bross como ilustração da nossa página. Este site tem como finalidade o usuário entrar em contato com a empresa ou prestadora de serviços através de um formulário, que é preenchido após clicar no botão "Fale conosco", e após o preechimento do mesmo, clicando no botão de enviar será encaminhado um e-mail para a empresa. Utilizei neste projeto HTML5, CSS3, Javascript, API Formsubmit e uma Máscara para o input de telefone.
  <br>Hospedei meu site na Netlify e vinculei com meu Github para que toda alteração que eu chegar a fazer seja atualizada automaticamente. O código foi codificado por mim no VScode com a instrução através de uma Imersão "Programador em 72 hrs" feita pelo Rodolfo Mori da instituição  DevClub.
  <br>No código original fiz algumas inclusões, tais como:
<br>-Uma mascara no campo de telefone para que o preenchimento seja o correto.
...
<br>https://site-mario-bros.netlify.app/
<br>
...
<div display="flex">
   ...
   <img src="https://github.com/MayDamato/Site-Mario/blob/main/assets/pagina%20sucesso%20cel.png" alt="formulario-na-tela-do-celular" width="300" height="600">
